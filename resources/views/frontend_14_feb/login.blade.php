...
<body style="background-image: url(frontend/images/login.jpg);" class="one-screen-page bg-gray-darker bg-image">
    <div class="page">
                ...
                <div class="shell">
                    <div class="range range-sm-center">
                        <div class="cell-sm-7 cell-md-5 cell-lg-4">
                                ...
                                <form class="rd-mailform form-modern form-darker offset-top-40">
                                    <div class="block-inner">
                                        <div class="form-group">
                                            <input id="login-form-name" type="text" name="name" data-constraints="@Required" class="form-control" placeholder="Username">
                                        </div>
                                        <div class="form-group offset-top-22">
                                            <input id="login-form-password" type="password" name="pass" data-constraints="@Required" class="form-control" placeholder="Password">
                                        </div>
                                        <div class="offset-top-22"><a href="#" class="link-default color-black">Forgot your password?</a></div>
                                    </div>
                            ...
                            <div class="group-inline offset-top-15 text-center"><span class="text-white">Haven’t an account?</span><a href="register.html" class="link link-primary-inverse">Sign up here.</a></div>
                        </div>
                    </div>
                </div>
            </section>
