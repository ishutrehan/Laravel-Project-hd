            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Closing Attorney <small>List all Closing Attorneys </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="#">Home</a>
                            </li>
                            <li class="active-page"> Closing Attorney List</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>List of All Closing Attorney</h4>
                    <a href="{{ url('admin/closing_attorney/create') }}" class="btn btn-primary add_btn"> Add Closing Attorney </a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                            ...
                            <div class="panel-body">
                                <form method="POST" id="search-form" class="form-inline" role="form">
                                    {{-- <div class="form-group col-md-3 col-sm-4 col-xs-12" style="padding: 0px 5px;">
                                        <label for="client_name">closing_attorney</label>
                        ...
                        <div class="table-responsive">
                            <table id="datatable_closing_attorney" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Profile Pic</th>
                                    <th>Closing Attorney Name</th>
                                    <th>Address</th>
                                    <th>Email</th>
                                    {{-- <th>Address</th> --}}
                                    <th>Created At</th>
...
@section('custom_script')
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            oTable = $('#datatable_closing_attorney').DataTable({
                processing: true,
                serverSide: true,
                "order": [ 5, 'desc' ],
                headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                ajax:{
                  url: '{{ URL("admin/closing_attorney/fetch_closing_attorney") }}',
                  data: function(d){
                ...
                columns: [
                    ...
                    {data: 'closing_attorney_name', name: 'closing_attorney_name'},
            ...
            $(document).on('click','.edit',function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                var closing_attorney_unique_id = value['1'];
                window.location.href = "{{ URL('admin/closing_attorney/edit') }}/"+closing_attorney_unique_id;
            });
            ...
            $(document).on('click','.view',function(){
                ...
                var value = id.split('-');
                var closing_attorney_unique_id = value['1'];
                window.location.href = "{{ URL('admin/closing_attorney/view') }}/"+closing_attorney_unique_id;
            });
            ...
            $(document).on('click', '.delete', function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                closing_attorney_id = value['1'];
                swal({
                    title: 'Are you sure..?',
                    text: "Do you really want to delete this Closing Attorney..?",
                    type: 'warning',
                    showCancelButton: true,
                }, function(){
                    if(closing_attorney_id != '')
                    {
                        $.ajax({
                            url: '{{ url('admin/closing_attorney/delete') }}',
                            type: 'POST',
                            headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                            data: {
                                closing_attorney_id: closing_attorney_id
                            },
                            success: function(response){
                                ...
                                if(resp.status == 1)
                                {
                                    swal({
                                        title: 'Deleted..!',
                                        text: "Closing Attorney deleted successfully.",
                                        type: 'success',
                                    }, function(){
                                        oTable.draw();
                                    });
