            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Closing Attorney <small>Add New Closing Attorney </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url('admin') }}">Home</a>
                            </li>
                            <li class="active-page"> Add New Closing Attorney</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>Add New Closing Attorney</h4>
                    <a href="{{ url('admin/closing_attorney') }}" class="btn btn-danger add_btn">Cancel</a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                        <form method="POST" class="form-horizontal" id="add_closing_attorney" enctype="multipart/form-data">
                            {{-- {!! csrf_field() !!} --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="license_number" id="license_number" placeholder="Enter License Number" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Bar ID</label>
                                <div class="col-md-8">
                                    <input type="text" name="bar_id" id="bar_id" placeholder="Enter Campany Name" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button" name="cancel_btn" id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/closing_attorney') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            $("#add_closing_attorney").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('admin/closing_attorney/create') }}",
                        data: new FormData($("#add_closing_attorney")[0]),
                        processData: false,
                        contentType: false,
                        dataType: 'JSON',
                        success: function(response){
                           if(response.status == 1) {
                                swal({
                                    title: 'Added',
                                    text: "Closing Attorney Added Successfully.",
                                    type: 'success'
                                }, function () {
