            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Inspector <small>List all Inspectors </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="#">Home</a>
                            </li>
                            <li class="active-page"> Inspector List</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>List of All Inspector</h4>
                    <a href="{{ url('admin/inspector/create') }}" class="btn btn-primary add_btn">Add Inspector</a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                            ...
                            <div class="panel-body">
                                <form method="POST" id="search-form" class="form-inline" role="form">
                                    {{-- <div class="form-group col-md-3 col-sm-4 col-xs-12" style="padding: 0px 5px;">
                                        <label for="client_name">Inspector</label>
                        ...
                        <div class="table-responsive">
                            <table id="datatable_inspector" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Profile Pic</th>
...
@section('custom_script')
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            oTable = $('#datatable_inspector').DataTable({
                processing: true,
                serverSide: true,
                "order": [ 5, 'desc' ],
                headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                ajax:{
                  url: '{{ URL("admin/inspector/fetch_inspector") }}',
                  data: function(d){
                ...
                columns: [
                    ...
                    {data: 'inspector_name', name: 'inspector_name'},
            ...
            $(document).on('click','.edit',function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                var inspector_unique_id = value['1'];
                window.location.href = "{{ URL('admin/inspector/edit') }}/"+inspector_unique_id;
            });
            ...
            $(document).on('click','.view',function(){
                ...
                var value = id.split('-');
                var inspector_unique_id = value['1'];
                window.location.href = "{{ URL('admin/inspector/view') }}/"+inspector_unique_id;
            });
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    ...
                    {
                        $.ajax({
                            url: '{{ url('admin/inspector/delete') }}',
                            type: 'POST',
                            headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                            data: {
