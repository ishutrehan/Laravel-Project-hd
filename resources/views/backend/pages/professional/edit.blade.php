            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Professional <small>Edit Professional </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url('admin') }}">Home</a>
                            </li>
                            <li class="active-page"> Edit Professional</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <a href="{{ url('admin/professional') }}" class="btn btn-danger add_btn">Cancel</a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                        <form method="POST" class="form-horizontal" id="edit_professional" enctype="multipart/form-data">
                            {{-- {!! csrf_field() !!} --}}
                            <input type="hidden" name="professional_id" value="{{ $professional_details[0]->user_id }}">
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Full Name</label>
                                <div class="col-md-4">
                                    <input type="text" name="first_name" id="first_name" placeholder="Enter First Name" value="{{ $professional_details[0]->first_name }}" class="form-control"/>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="last_name" id="last_name" placeholder="Enter Last Name" value="{{ $professional_details[0]->last_name }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Address</label>
                                <div class="col-md-8">
                                    <textarea type="text" name="address" id="address" placeholder="Enter Address" class="form-control" style="resize: vertical; min-height: 100px; max-height: 100px">{{ $professional_details[0]->address }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="zip_code" id="zip_code" placeholder="Enter Zip Code" value="{{ $professional_details[0]->zip_code }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Email</label>
                                <div class="col-md-8">
                                    <input type="text" name="email" id="email" placeholder="Enter Email Address" value="{{ $professional_details[0]->email }}" disabled class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Username</label>
                                <div class="col-md-8">
                                    <input type="text" name="username" disabled id="username" placeholder="Enter Username" value="{{ $professional_details[0]->username }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Telephone</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control phone_us-mask" name="telephone" id="telephone" value="{{ $professional_details[0]->telephone }}" placeholder="Enter Telephone Number" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Mobile</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control phone-mask" name="mobile" id="mobile" value="{{ $professional_details[0]->telephone }}" placeholder="Enter Mobile Number" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {{-- <a href="{{ url('uploads/professional') }}/{{$attach['uplaod_filename']}}" class="btn btn- btn-warning" download><i class="fa fa-download"> </i> {{ $attach['original_filename'] }} </a> --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" name="id_proof_attached" id="id_proof_attached">
                                        ...
                                        <option value="1" @if($professional_details[0]->id_proof_attached == 1) selected @endif>Driving license</option>
                                        <option value="2" @if($professional_details[0]->id_proof_attached == 2) selected @endif>State Proof</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="license_number" id="license_number" placeholder="Enter License Number" value="{{ $professional_details[0]->license_number }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control select2" name="license_type" id="license_type" placeholder="License Type">
                                        {{-- <option style="color:#aaaaaa;" value="" disabled> Select ID Proof </option> --}}
                                        <option value="1" @if($professional_details[0]->licensed_type == 1) selected @endif>Driving license</option>
                                        <option value="2" @if($professional_details[0]->licensed_type == 2) selected @endif>State Proof</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button"  id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/professional') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
@section('custom_script')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            $("#state option[value='{{ $professional_details[0]->state }}']").attr('selected', true);
            $("#licensed_state option[value='{{ $professional_details[0]->licensed_state }}']").attr('selected', true);
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            if(data)
                            {
                                ...
                                $("#city").html(allOption);
                                $("#city option[value='{{ $professional_details[0]->city }}']").attr('selected', true);
                                $("#city").select2({
            ...
            $("#edit_professional").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('admin/professional/update') }}",
                        data: new FormData($("#edit_professional")[0]),
                        processData: false,
                        contentType: false,
                        dataType: 'JSON',
