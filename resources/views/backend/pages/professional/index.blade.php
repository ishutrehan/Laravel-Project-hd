            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Professional <small>List all Professionals </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="#">Home</a>
                            </li>
                            <li class="active-page"> Professional List</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>List of All Professional</h4>
                    <a href="{{ url('admin/professional/create') }}" class="btn btn-primary add_btn"> Add Professional </a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                            ...
                            <div class="panel-body">
                                <form method="POST" id="search-form" class="form-inline" role="form">
                                    {{-- <div class="form-group col-md-3 col-sm-4 col-xs-12" style="padding: 0px 5px;">
                                        <label for="client_name">Professional</label>
                        ...
                        <div class="table-responsive">
                            <table id="datatable_realtor" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Profile Pic</th>
                                    <th>Name</th>
...
@section('custom_script')
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            oTable = $('#datatable_realtor').DataTable({
                processing: true,
                serverSide: true,
                "order": [ 5, 'desc' ],
                headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                ajax:{
                  url: '{{ URL("admin/professional/fetch_professional") }}',
                  data: function(d){
            ...
            $(document).on('click','.edit',function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                var realtor_unique_id = value['1'];
                window.location.href = "{{ URL('admin/professional/edit') }}/"+realtor_unique_id;
            });
            ...
            $(document).on('click','.view',function(){
                ...
                var value = id.split('-');
                var realtor_unique_id = value['1'];
                window.location.href = "{{ URL('admin/professional/view') }}/"+realtor_unique_id;
            });
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    title: 'Are you sure..?',
                    text: "Do you really want to delete this realtor..?",
                    type: 'warning',
                    ...
                    {
                        $.ajax({
                            url: '{{ url('admin/professional/delete') }}',
                            type: 'POST',
                            headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                            data: {
