            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Buyers <small>List all Buyers </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url("admin") }}">Home</a>
                            </li>
                            <li class="active-page"> Buyers List </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>Buyers List</h4>
                    <a href="{{ url('admin/buyer/create') }}" class="btn btn-primary add_btn"> Add Buyer </a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                            ...
                            <div class="panel-body">
                                <form method="POST" id="search-form" class="form-inline" role="form">
                                    {{-- <div class="form-group col-md-3 col-sm-4 col-xs-12" style="padding: 0px 5px;">
                                        <label for="client_name">Buyers</label>
                        ...
                        <div class="table-responsive">
                            <table id="datatable_buyers" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Profile Pic</th>
                                    <th>Buyers</th>
...
@section('custom_script')
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            oTable = $('#datatable_buyers').DataTable({
                processing: true,
                serverSide: true,
                "order": [ 5, 'desc' ],
                headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                ajax:{
                  url: '{{ URL("admin/buyer/fetch_buyers") }}',
                  data: function(d){
                ...
                columns: [
                    ...
                    {data: 'buyers_name', name: 'buyers_name'},
            ...
            $(document).on('click','.edit',function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                var buyer_unique_id = value['1'];
                window.location.href = "{{ URL('admin/buyer/edit') }}/"+buyer_unique_id;
            });
            ...
            $(document).on('click','.view',function(){
                ...
                var value = id.split('-');
                var buyer_unique_id = value['1'];
                window.location.href = "{{ URL('admin/buyer/view') }}/"+buyer_unique_id;
            });
