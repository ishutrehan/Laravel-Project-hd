                        ...
                        <form method="POST" class="form-horizontal" id="add_mortgage_officer" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button" name="cancel_btn" id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/mortgage') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        success: function(response){
                           if(response.status == 1) {
                                swal({
                                    ...
                                    text: "Mortgage Loan Officer Added Successfully.",
                                    type: 'success'
                                }, function () {
