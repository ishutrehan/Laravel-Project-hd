            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Mortgage Loan Officer <small> List of Mortgage Loan Officer </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="#">Home</a>
                            </li>
                            <li class="active-page"> Mortgage Loan Officer List</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>Mortgage Loan Officer List</h4>
                    <a href="{{ url('admin/mortgage/create') }}" class="btn btn-primary add_btn">Add Mortgage Officer</a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                        ...
                        <div class="table-responsive">
                            <table id="datatable_mortgage" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Profile Pic</th>
                                    <th>Mortgage Loan Officer</th>
                                    <th>Address</th>
                                    <th>Email</th>
                                    {{-- <th>Address</th> --}}
                                    <th>Created At</th>
...
@section('custom_script')
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            oTable = $('#datatable_mortgage').DataTable({
                processing: true,
                serverSide: true,
                "order": [ 5, 'desc' ],
                headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                ajax:{
                  url: '{{ URL("admin/mortgage/fetch_mortgage") }}',
                  data: function(d){
                ...
                columns: [
                    ...
                    {data: 'mortgage_name', name: 'mortgage_name'},
            ...
            $(document).on('click','.edit',function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                var mortgage_unique_id = value['1'];
                window.location.href = "{{ URL('admin/mortgage/edit') }}/"+mortgage_unique_id;
            });
            ...
            $(document).on('click','.view',function(){
                ...
                var value = id.split('-');
                var mortgage_unique_id = value['1'];
                window.location.href = "{{ URL('admin/mortgage/view') }}/"+mortgage_unique_id;
            });
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    title: 'Are you sure..?',
                    text: "Do you really want to delete this Mortgage Loan Officer..?",
                    type: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function(response){
                                ...
                                if(resp.status == 1)
                                {
                                    swal({
                                        title: 'Deleted..!',
                                        text: "Mortgage Loan Officer deleted successfully.",
                                        type: 'success',
                                    }, function(){
                                        oTable.draw();
                                    });
