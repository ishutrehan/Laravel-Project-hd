            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Seller <small>List all Sellers </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url("admin") }}">Home</a>
                            </li>
                            <li class="active-page"> Seller List</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="widget-container">
                    <div class=" widget-block">
                            ...
                            <div class="panel-body">
                                <form method="POST" id="search-form" class="form-inline" role="form">
                                    {{-- <div class="form-group col-md-3 col-sm-4 col-xs-12" style="padding: 0px 5px;">
                                        <label for="client_name">Seller</label>
                        ...
                        <div class="table-responsive">
                            <table id="datatable_sellers" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Profile Pic</th>
                                    <th>Sellers Name</th>
