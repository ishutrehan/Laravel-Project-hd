            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Realtor <small>List all Realtors </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="#">Home</a>
                            </li>
                            <li class="active-page"> Realtor List</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>List of All Realtor</h4>
                    <a href="{{ url('admin/realtor/create') }}" class="btn btn-primary add_btn"> Add Realtor </a>
                </div>
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            oTable = $('#datatable_realtor').DataTable({
                ...
                ajax:{
                  url: '{{ URL("admin/realtor/fetch_realtor") }}',
                  data: function(d){
                ...
                columns: [
                    ...
                    {data: 'realtor_name', name: 'realtor_name'},
            ...
            $(document).on('click','.edit',function(){
                ...
                window.location.href = "{{ URL('admin/realtor/edit') }}/"+realtor_unique_id;
            });
            ...
            $(document).on('click','.view',function(){
                ...
                var value = id.split('-');
                var realtor_unique_id = value['1'];
                window.location.href = "{{ URL('admin/realtor/view') }}/"+realtor_unique_id;
            });
