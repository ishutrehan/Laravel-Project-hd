            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Realtor <small>Add New Realtor </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url('admin') }}">Home</a>
                            </li>
                            <li class="active-page"> Add New Realtor</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="box-widget widget-module">
                ...
                <div class="widget-container">
                    <div class=" widget-block">
                        <form method="POST" class="form-horizontal" id="add_realtor" enctype="multipart/form-data">
                            {{-- {!! csrf_field() !!} --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button" name="cancel_btn" id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/realtor') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            $("#add_realtor").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('admin/realtor/create') }}",
                        data: new FormData($("#add_realtor")[0]),
                        processData: false,
                        contentType: false,
                        dataType: 'JSON',
