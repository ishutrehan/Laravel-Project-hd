            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Seller <small>Add New Seller </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="#">Home</a>
                            </li>
                            <li class="active-page"> Add New Seller</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="box-widget widget-module">
                ...
                <div class="widget-container">
                    <div class=" widget-block">
                        <form method="POST" class="form-horizontal" id="add_seller" enctype="multipart/form-data">
                            {{-- {!! csrf_field() !!} --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button" name="cancel_btn" id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/seller') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
			...
			$("#add_seller").validate({
	            ...
	            submitHandler: function () {
	                ...
	                $.ajax({
	                    ...
	                    url: "{{ url('admin/seller/create') }}",
	                    data: new FormData($("#add_seller")[0]),
                        processData: false,
                        contentType: false,
                        dataType: 'JSON',
