            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Contractors <small>List of Contractors </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url('admin') }}">Home</a>
                            </li>
                            <li class="active-page"> Contractors List</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <a href="{{ url('admin/contractors/create') }}" class="btn btn-primary add_btn"> Add Contractor </a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                        ...
                        <div class="table-responsive">
                            <table id="datatable_contractors" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Profile Pic</th>
...
@section('custom_script')
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            oTable = $('#datatable_contractors').DataTable({
                processing: true,
                serverSide: true,
                "order": [ 5, 'desc' ],
                headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                ajax:{
                  url: '{{ URL("admin/contractors/fetch_contractors") }}',
                  data: function(d){
                ...
                columns: [
                    ...
                    {data: 'contractors_name', name: 'contractors_name'},
            ...
            $(document).on('click','.edit',function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                var contractors_unique_id = value['1'];
                window.location.href = "{{ URL('admin/contractors/edit') }}/"+contractors_unique_id;
            });
            ...
            $(document).on('click','.view',function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                var contractors_id = value['1'];
                window.location.href = "{{ URL('admin/contractors/view') }}/"+contractors_id;
            });
            ...
            $(document).on('click', '.delete', function(){
                ...
                var id = $(this).attr('id');
                var value = id.split('-');
                contractors_id = value['1'];
                swal({
                    title: 'Are you sure..?',
                    text: "Do you really want to delete this contractor..?",
                    type: 'warning',
                    ...
                    {
                        $.ajax({
                            url: '{{ url('admin/contractors/delete') }}',
                            type: 'POST',
                            headers: { 'X-CSRF-TOKEN' : $('meta[name=_token]').attr('content') },
                            data: {
