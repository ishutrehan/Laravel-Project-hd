            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Contractors <small>Edit Contractors </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="#">Home</a>
                            </li>
                            <li class="active-page"> Edit Contractors</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>Edit Contractors</h4>
                    <a href="{{ url('admin/contractors') }}" class="btn btn-danger add_btn">Cancel</a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                        <form method="POST" class="form-horizontal" id="edit_contractors" enctype="multipart/form-data">
                            {{-- {!! csrf_field() !!} --}}
                            <input type="hidden" name="contractors_id" value="{{ $contractors_details[0]->unique_id }}">
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Full Name</label>
                                <div class="col-md-4">
                                    <input type="text" name="first_name" id="first_name" placeholder="Enter First Name" value="{{ $contractors_details[0]->first_name }}" class="form-control"/>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="last_name" id="last_name" placeholder="Enter Last Name" value="{{ $contractors_details[0]->last_name }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Address</label>
                                <div class="col-md-8">
                                    <textarea type="text" name="address" id="address" placeholder="Enter Address" class="form-control" style="resize: vertical; min-height: 100px; max-height: 100px">{{ $contractors_details[0]->address }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="zip_code" id="zip_code" placeholder="Enter Zip Code" value="{{ $contractors_details[0]->zip_code }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Email</label>
                                <div class="col-md-8">
                                    <input type="text" name="email" id="email" placeholder="Enter Email Address" value="{{ $contractors_details[0]->email }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Username</label>
                                <div class="col-md-8">
                                    <input type="text" name="username" id="username" placeholder="Enter Username" value="{{ $contractors_details[0]->username }}" class="form-control"/>
                                </div>
                            </div>
                            {{-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control phone_us-mask" name="telephone" id="telephone" value="{{ $contractors_details[0]->telephone }}" placeholder="Enter Telephone Number" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Mobile</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control phone-mask" name="mobile" id="mobile" value="{{ $contractors_details[0]->telephone }}" placeholder="Enter Mobile Number" />
                                </div>
                            </div>
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="license_number" id="license_number" value="{{ $contractors_details[0]->license_number }}" placeholder="Enter License Number" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Classification</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="classification" id="classification" value="{{ $contractors_details[0]->classification }}" placeholder="Enter classification no." />
                                </div>
                            </div>
                            <?php $experience = json_decode($contractors_details[0]->experience, true); ?>
                            <div class="form-group">
                            ...
                            <?php $profile_pic = json_decode($contractors_details[0]->profile_pic, true); ?>
                            <div class="form-group">
                            ...
                            <?php $attach = json_decode($contractors_details[0]->id_proof_attachment, true); ?>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">Previous Document</label>
                                <div class="col-md-8">
                                    {{-- <a href="{{ url('uploads/contractors') }}/{{$attach['upload_filename']}}" class="btn btn- btn-warning" download><i class="fa fa-download"> </i> {{ $attach['original_filename'] }} </a> --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" name="id_proof_attached" id="id_proof_attached">
                                        ...
                                        <option value="1" @if($contractors_details[0]->id_proof_attached == 1) selected @endif>Driving license</option>
                                        <option value="2" @if($contractors_details[0]->id_proof_attached == 2) selected @endif>State Proof</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <input type="file" class="filestyle" data-buttontext="Attach ID Proof" name="id_proof_file" id="id_proof_file" data-buttonname="btn-info" accept="doc,pdf,rtf,docx,jpg">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button"  id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/contractors') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="{{ url('uploads/contractors/profile_pic') }}/{{$profile_pic['upload_filename']}}" style="width: 100%" />
            </div>
...
<div class="modal fade id-proof-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="{{ url('uploads/contractors/id_proof') }}/{{$attach['upload_filename']}}" style="width: 100%" />
            </div>
            <div class="modal-footer" style="text-align: center;">
                <button type="button" class="btn btn-primary"  data-dismiss="modal">Close</button>
            </div>
...
@section('custom_script')
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
            ...
            $("#state option[value='{{ $contractors_details[0]->state }}']").attr('selected', true);
            $("#licensed_state option[value='{{ $contractors_details[0]->licensed_state }}']").attr('selected', true);
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            if(data)
                            {
                                ...
                                $("#city").html(allOption);
                                $("#city option[value='{{ $contractors_details[0]->city }}']").attr('selected', true);
                                $("#city").select2({
			...
			$("#edit_contractors").validate({
	            ...
	            rules: {
                    ...
                    id_proof_attachment: {
                        required: true,
                        //extension: "gif|png|jpeg|jpg" // for extension but not working
                    },
	            ...
	            submitHandler: function () {
                    ...
                    $.ajax({
	                    ...
	                    url: "{{ url('admin/contractors/update') }}",
	                    data: new FormData($("#edit_contractors")[0]),
                        processData: false,
                        contentType: false,
                        dataType: 'JSON',
	                    success: function(response){
	                       if(response.status == 1) {
								...
								swal({
                                    ...
                                    text: "Contractor Update Successfully.",
                                    type: 'success'
                                    }, function () {
