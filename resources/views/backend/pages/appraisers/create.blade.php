            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Appraisers <small> Add New Appraisers </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url('admin') }}">Home</a>
                            </li>
                            <li class="active-page"> Add New Appraisers</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>Add New Appraisers</h4>
                    <a href="{{ url('admin/appraisers') }}" class="btn btn-danger add_btn">Cancel</a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                        <form method="POST" class="form-horizontal" id="add_appraisers" enctype="multipart/form-data">
                            {{-- {!! csrf_field() !!} --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button" name="cancel_btn" id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/appraisers') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            $("#add_appraisers").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('admin/appraisers/create') }}",
                        data: new FormData($("#add_appraisers")[0]),
                        processData: false,
                        contentType: false,
                        dataType: 'JSON',
                        success: function(response){
                            if(response.status == 1) {
                                ...
                                swal({
                                    ...
                                    text: "Appraiser Added Successfully.",
                                    type: 'success'
                                    }, function () {
