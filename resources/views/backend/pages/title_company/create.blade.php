            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Title Company <small>Add New Title Company </small></h2>
                        <ul class="list-page-breadcrumb">
                            <li><a href="{{ url('admin') }}">Home</a>
                            </li>
                            <li class="active-page"> Add New Title Company</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box-widget widget-module">
                <div class="widget-head clearfix">
                    ...
                    <h4>Add New Title Company</h4>
                    <a href="{{ url('admin/title_company') }}" class="btn btn-danger add_btn">Cancel</a>
                </div>
                <div class="widget-container">
                    <div class=" widget-block">
                        <form method="POST" class="form-horizontal" id="add_title_company" enctype="multipart/form-data">
                            {{-- {!! csrf_field() !!} --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="company_name" id="company_name" placeholder="Enter Campany Name" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">NAIC</label>
                                <div class="col-md-8">
                                    <input type="text" name="naic" id="naic" placeholder="Enter NAIC" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-md-offset-1 control-label">NPN</label>
                                <div class="col-md-8">
                                    <input type="text" name="npn" id="npn" placeholder="Enter NPN" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button" name="cancel_btn" id="cancel_btn" class="btn btn-danger" onclick="window.location.href = '{{ url('admin/title_company') }}'">CANCEL</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            $("#add_title_company").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('admin/title_company/create') }}",
                        data: new FormData($("#add_title_company")[0]),
                        processData: false,
                        contentType: false,
                        dataType: 'JSON',
                        success: function(response){
                           if(response.status == 1) {
                                swal({
                                    title: 'Added',
                                    text: "Title Company Added Successfully.",
                                    type: 'success'
                                }, function () {
