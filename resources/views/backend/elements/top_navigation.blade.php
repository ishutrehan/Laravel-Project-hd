                        ...
                        <ul>
                            ...
                            <li class="dropdown">
                                ...
                                <a data-toggle="dropdown" href="#" class="clearfix dropdown-toggle waves-effect waves-block waves-classic">
                                    ...
                                    <span class="user-info">Houz Dealz <cite>houzdealz@gmail.com</cite></span>

                                    <span class="user-thumb"><img src="{{ asset('backend/images/avatar/jaman.jpg') }}" alt="image"></span>
                                ...
                                <ul role="menu" class="dropdown-menu fadeInUp">
                                    ...
                                    <li><a href="logout"><span class="user-nav-icon"><i class="fa fa-lock"></i></span><span class="user-nav-label">Logout</span></a>
