<div class="right-aside">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="coversetaion">
                ...
                <div class="block-content chat-user-list">
                    ...
                    <ul class="chat-list">
                        <li>
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/adellecharles.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Adellecharles<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                        <li class="chat-u-online">
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/allisongrayce.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Allisongrayce<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                        <li class="chat-u-online">
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/bobbyjkane.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Bobbyjkane<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                        <li class="chat-u-online">
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/littlenono.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Littlenono<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                    </ul>
                    ...
                    <ul class="chat-list">
                        <li>
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/geeftvorm.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Geeftvorm<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                        <li class="chat-u-online">
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/amarkdalen.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Amarkdalen<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                        <li>
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/mko.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Mko<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                        <li>
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/marktimemedia.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Marktimemedia<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                        <li>
                            <a href="#"><span class="chat-avatar"><img src="{{ asset('backend/images/avatar/oykun.jpg') }}" alt="Avatar"></span><span class="chat-u-info">Oykun<cite>New York</cite></span></a>
                            <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="block-content">
                    <div class="aside-notifications-wrap">
                        <div class="message-wrap">
                            ...
                            <ul class="clearfix">
                                <li class="clearfix">
                                    <a href="#" class="message-thumb"><img src="{{ asset('backend/images/avatar/adellecharles.jpg') }}" alt="image">
                                ...
                                <li class="clearfix">
                                    <a href="#" class="message-thumb"><img src="{{ asset('backend/images/avatar/allisongrayce.jpg') }}" alt="image">
                                ...
                                <li class="clearfix">
                                    <a href="#" class="message-thumb"><img src="{{ asset('backend/images/avatar/amarkdalen.jpg') }}" alt="image">
                                ...
                                <li class="clearfix">
                                    <a href="#" class="message-thumb"><img src="{{ asset('backend/images/avatar/annapickard.jpg') }}" alt="image">
                                ...
                                <li class="clearfix">
                                    <a href="#" class="message-thumb"><img src="{{ asset('backend/images/avatar/bobbyjkane.jpg') }}" alt="image">
                                ...
                                <li class="clearfix">
                                    <a href="#" class="message-thumb"><img src="{{ asset('backend/images/avatar/chexee.jpg') }}" alt="image">
                                ...
                                <li class="clearfix">
                                    <a href="#" class="message-thumb"><img src="{{ asset('backend/images/avatar/coreyweb.jpg') }}" alt="image">
    ...
    <div class="conv-container">
        <div class="conv-u-info chat-u-online">
            <ul>
                <li class="chat-avatar"><img src="{{ asset('backend/images/avatar/adellecharles.jpg') }}" alt="Avatar">
                </li>
        ...
        <div class="converstaion-list">
            <div class="conversation-back">
                <div class="conv-thumb">
                    <img src="{{ asset('backend/images/avatar/uxceo.jpg') }}" alt="user">
                </div>
                <div class="conv-text">
