                    ...
                    <div class="range range-sm-center">
                        <div class="cell-sm-7 cell-md-5 cell-lg-4">
                            <div class="block-shadow text-center">
                                ...
                                <form method="post" action="{{url('registration')}}" class="form-modern form-darker offset-top-40">
                                  {{ csrf_field() }}
                                    <div class="block-inner">
                                        <div class="form-group">
                                            <input id="register-form-name" type="text" name="name" required data-constraints="@Required" class="form-control" placeholder="Name" value="{{ old('name') }}">
                                        </div>
                                        <div class="form-group offset-top-22">
                                            <input id="feedback-email" type="email" name="email" required data-constraints="@Email @Required" class="form-control" placeholder="Email" value="{{ old('email') }}">
                                        </div>
                                        <div class="form-group offset-top-22">
                                            <input id="register-form-password" type="password" required name="password" data-constraints="@Required" class="form-control" placeholder="Password">
                                        </div>
                                        <div class="form-group offset-top-22">
                                            <input id="register-form-password-confirm" type="password" required name="password_confirm" data-constraints="@Required" class="form-control" placeholder="Repeat a password">
                                        </div> 
                                        <div class="form-group offset-top-22">
                                            <label>Sign Up As:</label>
                                            <select name="user_type" class="dark-color">
                                        ...
                                        <div class="offset-top-22 text-left text-secondary">
                                            <label class="checkbox-inline checkbox-small">
                                                <input name="terms" type="checkbox">I agree with the&nbsp;<a href="privacy-policy.html" class="link-primary-inline">Terms of use</a>.
                                            </label>
                                        </div>
                                    </div>
