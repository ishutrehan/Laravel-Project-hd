												...
												<ul class="padd-both">
													<li class="list-group-item">
														<div>
															...
															<select class="" name="search[state]" id="state_sel">
																<option></option>
																{!! $all_states !!}
															</select>
														</div>
													...
													<li class="list-group-item">
														<div>
															...
															<select class="" name="search[city]" id="city_all">
																<option></option>
															</select>
														</div>
													</li>
												...
												<ul class="list-group">
													@foreach($school_distance as $school_dist)
														<li class="list-group-item">
															<div class="checkbox">
																<label>
																	<input type="checkbox" value="{{ $school_dist }}">
												...
												<ul class="list-group">
													@foreach($nearest_market as $near_mark)
														<li class="list-group-item">
															<div class="checkbox">
																<label>
																	<input type="checkbox" value="{{ $near_mark }}">
												...
												<ul class="list-group">
													@foreach($nearest_hospital as $nearest_hos)
														<li class="list-group-item">
															<div class="checkbox">
																<label>
																	<input type="checkbox" value="{{ $nearest_hos }}">
											...
											<div class="product-slider-inner">
												...
												<div data-items="1" data-stage-padding="0" data-loop="true" data-margin="30" data-mouse-drag="true" data-dots="true" data-animation-in="fadeIn" data-animation-out="fadeOut" class="owl-carousel owl-style-minimal">
													@foreach($images as $image)
														<div class="item">
															<figure><img src="{!! asset('uploads/property').'/'.$image['upload_filename'] !!}" alt="{{ $image['original_filename'] }}" width="270" height="360"/>
															</figure>
														</div>
													@endforeach
													</div>
